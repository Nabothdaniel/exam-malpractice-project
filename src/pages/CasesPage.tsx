      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <button
            ...
            className="flex items-center w-full md:w-auto justify-center mt-5 md:mt-0 px-2 py-3 md:px-4 md:py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
